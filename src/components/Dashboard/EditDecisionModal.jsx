...
const EditDecisionModal = ({ isOpen, onClose, onEdit, decision }) => {
    ...
    useEffect(() => {
        if (decision) {
            ...
            const isPredefined = PREDEFINED_CATEGORIES.includes(cat);
            setFormData({
                ...
                <>
                    ...
                    >
                        <div className="flex justify-between items-center mb-6">
                            <h2 className="text-2xl font-bold text-slate-800 dark:text-white">Edit Decision</h2>
                            <button
                                onClick={onClose}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="pt-4 flex justify-end gap-3">
                                ...
                                <motion.button
                                    whileTap={{ scale: 0.95 }}
                                    type="submit"
                                    className="px-6 py-2.5 rounded-xl bg-blue-500 text-white font-medium hover:bg-blue-600 transition-colors shadow-[0_0_15px_#3b82f64d]"
                                >
                                    Save Changes
                                </motion.button>
                            </div>
